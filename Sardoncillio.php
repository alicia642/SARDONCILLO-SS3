...
.style1 {color:rgb(253, 0, 198)}
.style2 {
	color:rgb(0, 4, 255);
	font-weight: bold;
}
.style3 {color:rgb(209, 86, 158)}
.style7 {color:rgb(0, 38, 255); font-style: italic; }
body {
	background-color:rgb(151, 83, 179);
}
.style8 {color:rgb(183, 201, 25)}
  ...
  <tbody><tr>
    <td><h1 align="center">&nbsp;</h1>
      ...
      <table width="82%" border="0" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr bgcolor="#fac0e7">
          <td align="center" bgcolor="#fac0e7">Lumber</td>
          <td align="right" bgcolor="#fac0e7">$ 150,000.00</td>
        ...
        <tr bgcolor="#fac0e7">
          <td align="center" bgcolor="#fac0e7">Drywall</td>
          <td align="right" bgcolor="#fac0e7">$ 69,000.00</td>
          <td align="right"><span class="style7"><?php
            $cost = 69000.00;
            $total_cost = $cost + $cost * 0.10;
            echo "$ " . number_format($total_cost, 2);
        ...
        <tr bgcolor="#fac0e7">
          <td align="center" bgcolor="#fac0e7">Miscellaneous</td>
          <td align="right" bgcolor="#fac0e7">$ 20,000.00</td>
          <td align="right"><span class="style7"><?php
            $cost = 20000.00;
            $total_cost = $cost + $cost * 0.10;
            echo "$ " . number_format($total_cost, 2);
        ...
        <tr>
        <td colspan="5" align="right"><h4>Created by: &lt;<em>Alicia Joy D. Sardoncillo</em>&gt;</h4></td>
        </tr>
      </tbody></table>      
